...
import {Progression} from "./src/Entities/Progression";
...
// //getNotes Chord test:
// tester.methodTest(new Chord("Am"), (i) => i.getNotes, [[]], [['A', 'C', 'E']], 'get notes');
// tester.methodTest(new Chord("A"), (i) => i.getNotes, [[]], [['A', 'C#', 'E']], 'get notes');
// tester.methodTest(new Chord("Db"), (i) => i.getNotes, [[]], [['C#', 'F', 'G#']], 'get notes');

let chords = [new Chord("A"), new Chord("D")];
debugger;
tester.constructorTest(Progression, (i) => i.getChordsNames(), [chords], [["A", "D"]], 'progressions');
